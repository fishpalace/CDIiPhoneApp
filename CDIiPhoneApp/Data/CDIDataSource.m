...
{
    [[CDIDataSource sharedDataSource]fetchNews];
    [[CDIDataSource sharedDataSource]fetchProjects];
...
- (void)fetchEvents
{
    ...
    void (^handleData)(BOOL succeeded, id responseData) = ^(BOOL succeeded, id responseData){
        if ([responseData isKindOfClass:[NSDictionary class]]) {
            ...
            [CDIEvent removeAllEventInManagedObjectContext:self.managedObjectContext];
...
- (void)fetchNews
{
    ...
    void (^handleData)(BOOL succeeded, id responseData) = ^(BOOL succeeded, id responseData){
        ...
        if ([responseData isKindOfClass:[NSDictionary class]]) {
            [CDINews removeAllNewsInManagedObjectContext:self.managedObjectContext];
...
- (void)fetchProjects
{
    ...
    void (^handleData)(BOOL succeeded, id responseData) = ^(BOOL succeeded, id responseData){
        NSDictionary *rawDict = responseData;
        if ([responseData isKindOfClass:[NSDictionary class]]) {
            [CDIWork removeAllWorksInManagedObjectContext:self.managedObjectContext];
            NSArray *peopleArray = rawDict[@"data"];
            for (NSDictionary *dict in peopleArray) {
